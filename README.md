...
Claudia Campanini, Martina Coppari, Cristina Gioia Di Camillo, Chiara Gregorin, Teo Marrocco, Torcuato Pulido Mantas, Camilla Roveta, Carlo Cerrano,
Peering into the twilight: a systematic review on visual-based investigation of worldwide mesophotic ecosystems,
Marine Environmental Research, 2026, 108212, https://doi.org/10.1016/j.marenvres.2026.108212

![This is an image](/Mesophotic_methods_SLR_FIG2_updated.jpg)
...
- [Data analysis of extracted data](/Extracted_data_analysis)
  ...
  - Analyses of input data were run at a [global](/Extracted_data_analysis/global) level as well as for studies carried out in [temperate](/Extracted_data_analysis/temperate), [polar](/Extracted_data_analysis/polar) and in [tropical](/Extracted_data_analysis/tropical) latitudinal regions. In each dedicated subfolder, there is a script file written in R markdown, the corresponding report in html, a subfolder with transformed data and one for visualizations.

- [Removed_records_criteria.csv](/Removed_records_criteria.csv): List of records excluded from the review with specified removal criteria. Each removal criterion is exaplained in see [metadata](/metadata.xlsx). 
