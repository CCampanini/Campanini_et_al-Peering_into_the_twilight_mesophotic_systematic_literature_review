...
title: "Peering into the twilight - a systematic review on visual-based investigation
  of mesophotic ecosystems - TEMPERATE"
...
write.xlsx(count_results_method,
           file = here("Extracted_data_analysis",                        "temperate",                        "Output-Transformed_data",
...
lapply(names(treemap_counts), function(x){
  ggsave(filename=paste0("treemap",x,".tiff"), 
         plot=treemap_counts[[x]],
         units = "in", width=12, height=4, dpi=300, compression = 'lzw',
         path = here("Extracted_data_analysis","temperate",                        "Output-Visualization","Treemaps_methods"),
         create.dir = T
         )
  })
...
lapply(names(barchart_counts), function(x){
  ggsave(filename=paste0("bar_",x,".tiff"), 
         ...
         units = "in", width=12, height=4, dpi=300, compression = 'lzw',
         path = here("Extracted_data_analysis",                        "temperate",                        "Output-Visualization","Barcharts_split"),
         create.dir = T
         )
  })
...
lapply(names(barchart_counts), function(x){
  ggsave(filename=paste0("bar_",x,".tiff"), 
         plot=barchart_counts[[x]],
         units = "in", width=12, height=4, dpi=300, compression = 'lzw',
         path = here("Extracted_data_analysis",                        "temperate",                        "Output-Visualization","Barcharts_split_methods"), create.dir = T
         )
  })
...
lapply(names(barchart_counts), function(x){
  ggsave(filename=paste0("bar_",x,".png"), 
         plot=barchart_counts[[x]],
         units = "in", width=12, height=4, dpi=300,
         path = here("Extracted_data_analysis",                        "temperate",                        "Output-Visualization","Barcharts_split"), create.dir = T
         )
  })
```
...
```{r}
temperate$mininumSurveyedDepthInMeters <- as.numeric(temperate$mininumSurveyedDepthInMeters)
temperate$maximumSurveyedDepthInMeters <- as.numeric(temperate$maximumSurveyedDepthInMeters)
...
for (i in 1:nrow(pubs_depth)) {
  ...
  pubs_depth$count[i] <- sum(temperate$maximumSurveyedDepthInMeters >= bin_start & temperate$mininumSurveyedDepthInMeters < bin_end, na.rm = TRUE)
}
...
ggsave("pubs_depth.png", 
       ...
       path = here ("Extracted_data_analysis",                        "temperate",                        "Output-Visualization"))
```
...
new_spec_plot <-   ggplot(new_spec_tot, 
  ...
  coord_flip()+  # optional: flips for horizontal bars
  theme(legend.position ="none")+
  scale_x_discrete(labels = rev(c("Porifera",
                                "Cnidaria",
                                "Mollusca",
                                "Kinorhyncha",
                                "Crustacea",
...
new_spec_palette <- c("cnidaria" = "mediumvioletred",
                      "crustacea" = "indianred1",
                      "sponges" = "khaki1",
                      "mollusca" = "tan1",
                      "Kinorhyncha" = "gray69",
